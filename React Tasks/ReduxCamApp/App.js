...
import CameraFetchDemo from './src/misc/CameraFetchDemo';
import RNCamDemo from './src/misc/RNCamDemo';
import OtherCamDemo from './src/misc/OtherCamDemo';
import PDFDemo from './src/misc/PDFDemo';
import CameraRollDemo from './src/misc/CameraRollDemo';
import CameraRollOnly from './src/misc/CameraRollOnly';
import ImagePickerDemo from './src/ImagePickerDemo';
class App extends Component {
  render() {
    ...
    return <ImagePickerDemo />; // Works (finally)....
    /*--------------------------------------------*/
